...
export const STATIC_CONFIGS: IFilterConfig[] = [
  { key: 'status', label: 'todo.status', options: getStaticOptions(TODO_STATUS) },
  { key: 'labels', label: 'common.labels', options: getStaticOptions(TASK_LABELS) },
  { key: 'priority', label: 'todo.priority', options: getStaticOptions(TASK_PRIORITY) },
];
